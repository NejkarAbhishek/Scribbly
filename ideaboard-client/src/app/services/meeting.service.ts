...
export class MeetingService {
  ...
  getMeetings(page = 1, limit = 10): Observable<PaginatedResponse<Meeting>> {
    return this.http.get<PaginatedResponse<Meeting>>(`${this.base}?page=${page}&limit=${limit}`, this.headers());
  }
